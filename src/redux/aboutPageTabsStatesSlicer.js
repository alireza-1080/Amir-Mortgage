...
const initialState = {
    ...
    primaryMission: {
        icon: "./public/images/About-Page/missions/mission.svg",
        title: "Our Mission",
        details: "Get you the best possible mortgage rate.",
    },
    secondaryMissions: [
        {
            icon: "./public/images/About-Page/missions/complicated.svg",
        ...
        {
            icon: "./public/images/About-Page/missions/simplified.svg",
